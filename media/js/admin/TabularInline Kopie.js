$(document).ready(function(){
    ...
    /// add predelete class
    $('div.fieldset').find('input[name*="DELETE"]:checked').each(function(i) {
        $(this).parents('div.fieldset').addClass('predelete');
    });
    ...
    //     $('div.fieldset', this).each(function(i) {
    //         var order_value = $(this).find('input[id*="order"]').val();
    //         items[parseInt(order_value)] = $(this).clone(true);
    //     });
    //     items.sort();
    // });
    ...
    $('div.inline-tabular a.deletelink').bind("click", function() {
        ...
        $(this).parents('div.fieldset').toggleClass('predelete');
    });
    ...
    //             // });
    //             var input_values = $(this).find(':input:not([name*="order"])').map(function() {
    //                 return $(this).val();
    //             }).get().join("");
    ...
    $("form").submit(function() {
        $('div.inline-tabular.sortable').each(function() {
            ...
            $(this).find('div.fieldset').each(function(i) {
                ...
                // remove order values for empty items
                // var form_values = $(this).find(':input:not([name*="order"])').map(function() {
                //     if($(this).is(':checkbox')) {
                ...
                //     }
                // }).get().join("");
                // if (form_values == "" || find('input[name*="DELETE"]:checked')) {
                //     $(this).find('input[id*="order"]').val('');
                // } else {
                //     $(this).find('input[id*="order"]').val(x);
                //     x++;
                // }
            });
        });
