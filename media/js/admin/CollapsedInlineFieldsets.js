$(document).ready(function(){
    ...
    $('div[name="inlinerelated"] h2.collapse-toggle').bind("click", function(e){
    ...
    $('div[name="inlinegroup"] h3.collapse-toggle').bind("click", function(e){
        $(this).parent().toggleClass('collapsed');
    });
    /// TABULARINLINE
    ...
    $('div[name="inlinegrouptabular"] h3.collapse-toggle').bind("click", function(e){
        $(this).parent().toggleClass('collapsed');
    });
