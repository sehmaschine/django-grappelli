...
For using |grappelli| |grappelliversion|, `Django 6.0 <http://www.djangoproject.com>`_ needs to be installed and an `Admin Site <http://docs.djangoproject.com/en/6.0/ref/contrib/admin/>`_ has to be activated.
